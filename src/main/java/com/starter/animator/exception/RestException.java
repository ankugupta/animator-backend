...
public class RestException extends Exception {
	...
	public RestException(List<ErrorBean> errors, HttpStatus status) {
		this.errors = errors;
		this.httpStatus = status;
	}
	
	public RestException(ErrorBean error, HttpStatus status) {
	...
	public String toString() {
		return "RestException [errors=" + errors + ", httpStatus=" + httpStatus + "]";
	}
